...
export default function MobileSider() {
    ...
    return (
        <>
            <div id="sidebarOverlay" className="lg:hidden fixed inset-0 z-40 bg-black/50 hidden">
                <aside
                    className="fixed inset-y-0 left-0 z-50 w-64 bg-[#1A1A1A] border-r border-[#00eefd]/10
